...
6. Add `SHOPIFY_APP_URL='https://{your_forwarding_id}.ngrok.io'` 
...
9. [Set up your app navigation.](https://developers.shopify.com/tutorials/build-a-shopify-app-with-node-and-react/build-your-user-interface-with-polaris#set-up-your-app-navigation) (Do not write "index" for Simple resource list. Leave empty.)
